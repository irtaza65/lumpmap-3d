...
export const LumpDescriptionSchema = z
  .object({
    ...
    troubleBreathing: z.boolean().nullable(),
    spreadingRednessOrSwelling: z.boolean().nullable(),
    severeSystemicSymptoms: z.boolean().nullable(),
    blackGreyBlisteringOrNumbSkin: z.boolean().nullable(),
    painOutOfProportion: z.boolean().nullable(),
    suddenOnset: z.boolean().nullable(),
    swelling: z.boolean().nullable(),
    nearEyeOrCentralFace: z.boolean().nullable(),
    hardOrFixed: z.boolean().nullable(),
    steadilyGrowing: z.boolean().nullable(),
    unexplained: z.boolean().nullable(),
    persistent: z.boolean().nullable(),
    durationDays: z.number().int().min(0).max(36_500).nullable(),
